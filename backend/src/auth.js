...
import db from '#db';
import { validateLoginReq, validateSignupReq } from './services/validation.service.js';
...
authRouter.post('/me', requireAuth, (req, res) => {
  res.status(200).json({ authed: true, message: "Welcome!" })
})
